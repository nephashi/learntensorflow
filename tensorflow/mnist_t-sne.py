...
def generate_embeddings():
    ...
    embedding = tf.Variable(mnist.test.images, trainable=False, name='embedding')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/tmp/tensorflow/mnist/mnist_data',
                        help='Directory for storing input data')
    parser.add_argument('--log_dir', type=str, default='/tmp/tensorflow/mnist/mnist-tensorboard-embeddings/logs',
